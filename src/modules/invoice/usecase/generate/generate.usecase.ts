...
export default class GenerateInvoiceUseCase implements UseCaseInterface {
    ...
    async execute(input: GenerateInvoiceUseCaseInputDto): Promise<GenerateInvoiceUseCaseOutputDto> {
        ...
        const invoice = this.generateInvoice(input);
    ...
    private generateInvoice(input: GenerateInvoiceUseCaseInputDto): Invoice {
    ...
    private retrieveOutputDto(invoice: Invoice): GenerateInvoiceUseCaseOutputDto {
